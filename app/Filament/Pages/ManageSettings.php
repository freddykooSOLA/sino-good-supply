                        ...
                        Forms\Components\Tabs\Tab::make('联系方式')
                            ->schema([
                                Forms\Components\Fieldset::make('contact')
                                    ->label('联系信息')
                                    ->schema([
                                        Forms\Components\TextInput::make('contact.company_en')
                                            ->label('公司名称（英）'),
                                        Forms\Components\TextInput::make('contact.company_zh')
                                            ->label('公司名称（简）'),
                                        Forms\Components\TextInput::make('contact.company_zh_hant')
                                            ->label('公司名称（繁）'),
                                        Forms\Components\Textarea::make('contact.address_en')
                                            ->label('地址（英）')
                                            ->rows(2),
                                        Forms\Components\Textarea::make('contact.address_zh')
                                            ->label('地址（简）')
                                            ->rows(2),
                                        Forms\Components\Textarea::make('contact.address_zh_hant')
                                            ->label('地址（繁）')
                                            ->rows(2),
                                        ...
                                        Forms\Components\TextInput::make('contact.whatsapp')
                                            ->label('WhatsApp'),
                                        Forms\Components\TextInput::make('contact.wechat')
                                            ->label('微信'),
                                    ])
                                    ->columns(2),
                            ]),
